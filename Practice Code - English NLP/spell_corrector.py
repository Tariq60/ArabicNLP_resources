...
# NWORDS = train(words(file('C:/Users/Tariq/Dropbox (MIT)/Projects/3. ITS/Sentiment Analysis/my work/big.txt').read()))

# Arabic
NWORDS = train(file('C:/Users/Tariq/Dropbox (MIT)/Projects/3. ITS/Sentiment Analysis/my work/arabicText.txt').read().split())
